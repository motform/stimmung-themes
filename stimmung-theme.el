...
(let ((bg1 "gray12")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-string-face               ((t (:foreground ,fg3))))
   ...
   `(company-preview                  ((t (:background ,bg1 :foreground ,stimmung-highlight-color))))
   ...
   ;; ivy
   `(ivy-current-match              ((t (:foreground ,stimmung-highlight-color :background ,bg1 :bold t))))
   ...
   ;; org
   `(org-code                  ((t (:foreground ,stimmung-highlight-color :distant-foreground ,bg1 :background ,stimmung-highlight-color))))
