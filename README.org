...
Emacs packages often define their own faces, making theming a relatively sisyphean task. /Stimmung-themes/ defines all default faces and some of the most common packages, including [[https://github.com/emacs-lsp/lsp-ui][lsp-ui]], [[https://github.com/hlissner/emacs-solaire-mode][solaire]] and magit. Open an issue or make pull request if you lack a definition, they are always appreciated!
